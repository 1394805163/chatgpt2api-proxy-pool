...
class ModelCatalogService:
    ...
    def clear_cache(self) -> None:
        """清除模型目录缓存，供配置变更和兼容测试使用。"""
        with self._lock:
            self._expires_at = 0.0
            self._account_signature = ()
    ...
    def _fetch_account_type_models(
        ...
        for access_token in access_tokens:
            ...
            except Exception as exc:  # noqa: BLE001 - continue with another account in the type
                last_error = exc
    ...
    def _refresh(
        ...
        with ThreadPoolExecutor(max_workers=min(4, len(groups) + 1)) as executor:
            ...
            except Exception as exc:  # noqa: BLE001 - retain last good anonymous catalog
                logger.warning({
